  ...
  return (
    <Onboarding
      ...
      pages={[
        {
          backgroundColor,
          image: <Image {...imageProps} resizeMode="contain" source={require('../../assets/demo-1.png')} />,
        ...
        },
        {
          ...
          subtitle:
            '...or tap any kana to start typing. Then tap the [+] button to save the new word you just learned.',
        },
        {
          backgroundColor,
          image: <Image {...imageProps} source={require('../../assets/demo-3.png')} />,
          title: 'Hold down for other forms',
          subtitle: 'Access dakuten, handakuten, and yōon forms by pressing down on its base form.',
        },
        {
          backgroundColor,
          image: <Image {...imageProps} source={require('../../assets/demo-4.png')} />,
          title: 'Review your words',
          subtitle: `Tap the [カナ] button in the top right to access words you've learned and common phrases. Then tap the word to hear pronounciation, see translations, and more`,
        },
      ]}
    />
  );
